...
void VulkanRendering::createInstance() {
...
void VulkanRendering::pickPhysicalDevice() {
...
bool VulkanRendering::isDeviceSuitable(VkPhysicalDevice device) {
    ...
    return deviceProperties.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU &&
        ...
        findQueueFamilies(device).is_complete() &&
        extensionSupported &&
        swapChainAdequate;
}

bool VulkanRendering::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices VulkanRendering::findQueueFamilies(VkPhysicalDevice device) {
...
void VulkanRendering::createLogicalDevice() {
...
void VulkanRendering::drawFrame() {
    ...
    for (auto& bufferSet: commandBuffers) {
        buffersToSubmit.push_back(bufferSet.second[imageIndex]);
    }
